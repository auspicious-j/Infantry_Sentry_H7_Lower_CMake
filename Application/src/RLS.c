...
//      }
//     // x1Ϊ ����ٶ�ƽ���� x2Ϊ�������ƽ���� x3 ��ϳ����������������� yΪ���������  effctivePowerΪ��е����
//     // ���ʹ��setCurrent �뱣֤x2�뵱ǰ���ʵ�ʵ�����ͬ ��Ҫ�����ʿ���ǰ�ĵ����ù���
//     Xsample[0][0] = x1; // ����ٶ�ƽ����
//     Xsample[1][0] = x2; // �������ƽ����
//     Xsample[2][0] = x3; // ������
//     Ysample[0][0] = y;  // detaP
...
//     }
//     float deltaPower = power.paramVector[0][0] * Xsample[0][0] + power.paramVector[1][0] * Xsample[1][0] + power.paramVector[2][0] * Xsample[2][0]; // ������Ĺ���
//     return deltaPower;
// }
